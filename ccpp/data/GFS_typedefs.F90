...
!--- In (lakes)
    ...
    real (kind=kind_phys), pointer :: smokedc6_RRFS(:,:,:) => null()  !< RRFS fire 4 times input daily  !!JR added method 6
...
!------------------------
  subroutine sfcprop_create (Sfcprop, IM, Model)
    ...
    allocate (Sfcprop%smokedc6_RRFS(IM,5,6)) !JR added method 6
    ...
    Sfcprop%smokedc6_RRFS= clear_val  !JR added method 6
